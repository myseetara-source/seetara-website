  ...
  useEffect(() => {
    ...
    if (typeof window !== 'undefined' && window.fbq) {
      ...
      if (orderType === 'buy') {
        ...
        if (purchaseValue <= 0) {
          console.warn('⚠️ FB Pixel (SB107): Purchase value is 0 or invalid!', { grandTotal, purchaseValue });
        }
        ...
        console.log('✅ FB Pixel Purchase fired (SB107) with eventID:', eventId, 'Value:', purchaseValue);
