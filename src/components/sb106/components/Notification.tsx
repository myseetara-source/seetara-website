...
export default function Notification({ show, data }: NotificationProps) {
  return (
    <div className={`fixed top-24 right-4 z-[100] max-w-[90%] md:max-w-sm transform transition-all duration-500 ${show ? 'translate-x-0 opacity-100' : 'translate-x-[150%] opacity-0 pointer-events-none'}`}>
