...
import { ShoppingCart, Sparkles, Check, Briefcase } from 'lucide-react';
      ...
      <div className="max-w-md mx-auto px-4 py-3">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex-shrink-0">
            <div className="flex items-center gap-1">
              ...
              <span className="text-[10px] bg-emerald-600 text-white px-1.5 py-0.5 rounded-full font-bold">-{discountPercent}%</span>
            </div>
            <div className="flex items-center gap-1">
          ...
          <button
            ...
            className="flex-1 bg-gradient-to-r from-emerald-500 via-teal-500 to-emerald-500 text-white py-3 rounded-xl font-bold text-base flex items-center justify-center gap-2 shadow-xl animate-order-pulse relative overflow-hidden group"
          >
        ...
        <div className="flex items-center justify-center gap-3 mt-2 text-[10px] text-gray-500">
          <span className="flex items-center gap-1">
            <Check className="w-3 h-3 text-emerald-500" /> Cash on Delivery
          </span>
          <span className="text-gray-300">•</span>
          <span className="flex items-center gap-1">
            <Briefcase className="w-3 h-3 text-blue-500" /> Laptop Compatible
          </span>
        </div>
      </div>
    </div>
