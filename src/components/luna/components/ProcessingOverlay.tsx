...
import { CheckCircle2, Loader2, Package, MessageSquare, FileSpreadsheet, ExternalLink, Moon } from 'lucide-react';
    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-white/95 backdrop-blur-sm">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        {[...Array(15)].map((_, i) => (
          <div
            key={i}
            className="absolute w-2 h-2 bg-amber-400/40 rounded-full animate-particle-float"
            style={{
              left: `${10 + (i * 6) % 80}%`,
              top: `${10 + (i * 7) % 80}%`,
      ...
      <div className="relative bg-white rounded-2xl p-6 mx-4 max-w-xs w-full shadow-2xl border border-amber-100">
        {/* Header */}
        <div className="flex flex-col items-center mb-5">
          <div className="relative mb-3">
            ...
            <Moon className="absolute -top-1 -right-1 w-5 h-5 text-amber-500 animate-pulse" />
          </div>
