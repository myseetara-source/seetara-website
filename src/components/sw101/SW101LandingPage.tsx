...
export default function SW101LandingPage() {
  ...
  useEffect(() => {
    ...
    const initialTimeout = setTimeout(showNotificationPopup, 5000);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-amber-50/30 via-white to-orange-50/30 overflow-x-hidden">
      {/* Scroll Progress Bar */}
          ...
          {showScrollHint && (
            <div className="flex flex-col items-center justify-center py-4 animate-fade-in">
              ...
              <div className="w-7 h-12 border-2 border-amber-300 rounded-full flex items-start justify-center p-1.5 relative">
                <div className="w-2 h-3 bg-gradient-to-b from-amber-500 to-orange-600 rounded-full animate-scroll-mouse"></div>
              </div>
