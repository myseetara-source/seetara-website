...
import { User, Phone, MapPin, Home, Truck, CheckCircle2, ShieldCheck, Loader2, Sparkles, ShoppingBag, MessageCircle, ChevronRight, Moon } from 'lucide-react';
...
export default function OrderForm({
  ...
  return (
    <div id="order-form" className="px-4 py-4 scroll-mt-20">
      {/* Section Header - Free Pouch Highlight */}
      <div className="text-center mb-4">
        <div className="inline-flex items-center gap-2 bg-gradient-to-r from-pink-100 to-amber-100 px-4 py-2 rounded-full shadow-md border border-pink-200 mb-2 animate-pulse">
          <Moon className="w-5 h-5 text-amber-500" />
          <span className="text-sm font-black text-amber-700">FREE Matching Pouch! 👜</span>
        </div>
        <p className="text-xs text-gray-600">अहिले Order गर्नुहोस् - Free मा Matching Pouch पाउनुहोस्!</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
              ...
              {deliveryLocation && (
                <div className="bg-gradient-to-r from-amber-50 to-orange-50 p-3 rounded-xl border border-amber-200 space-y-1.5 animate-fade-in">
                  <div className="flex justify-between text-sm">
                    <span className="text-gray-600">Luna Bag:</span>
        ...
        <div className="p-4 pt-2">
          ...
          {/* Trust Note */}
          <div className="flex items-center justify-center gap-2 mt-3 text-[11px] text-gray-600 bg-amber-50 px-3 py-2 rounded-lg border border-amber-100">
