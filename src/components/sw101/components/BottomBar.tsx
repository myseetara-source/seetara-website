...
import { ShoppingCart, Sparkles, Check, Smartphone } from 'lucide-react';
      ...
      <div className="max-w-md mx-auto px-4 py-3">
        ...
        <div className="flex items-center justify-center gap-3 mt-2 text-[10px] text-gray-500">
          <span className="flex items-center gap-1">
            <Check className="w-3 h-3 text-amber-500" /> Cash on Delivery
          </span>
          <span className="text-gray-300">•</span>
          <span className="flex items-center gap-1">
            <Smartphone className="w-3 h-3 text-purple-500" /> Smart Pull-Tab
          </span>
        </div>
      </div>
    </div>
